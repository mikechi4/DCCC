...
angular.module('myApp').directive('graphDirective', function () {
  return {
    restrict: 'E',
    ...
    controller: function controller($scope) {
      var ChartVal = function ChartVal(label, value) {
        this.label = label;
        this.value = value;
      };

      $scope.$watch('job', function () {
        var thisWomenSalary = $scope.job[1] * 1;
        var thisMenSalary = $scope.job[4] * 1;
        var womenLabel = "Women Avg Salary";
        var menLabel = "Men Avg Salary";
